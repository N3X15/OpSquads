...
function ENT:SpawnFunction(ply, tr)
	...
	timer.Create(timername,1,0,function()	        	--
		...
		if(NumberOfCreeps>MaxEngagementNumberTable["SMG"])then
	...
	timer.Simple(0.1,function()
		...
		timer.Create(timername,1,0,function()	        	--
			...
			if(NumberOfCreeps>MaxEngagementNumberTable["AR2"])then
				local selfpos=npc:GetPos()
				local newpos=selfpos+((selfpos-npc:GetEnemy():GetPos()):GetNormalized())*500
				local checkdat={}
				checkdat.start=selfpos
	...
	timer.Simple(0.2,function()
		...
		timer.Create(timername,1,0,function()	        	--
			...
			if(NumberOfCreeps>MaxEngagementNumberTable["Shotgun"])then
				local selfpos=npc:GetPos()
				local newpos=selfpos+((selfpos-npc:GetEnemy():GetPos()):GetNormalized())*500
				local checkdat={}
				checkdat.start=selfpos
