...
language.Add("wep_jack_combine_br","Combine Battle Rifle")
killicon.Add("wep_jack_combine_br","vgui/killicons/wep_jack_combine_br",Color(255,255,255,255))

SWEP.PrintName="AI Combine Battle Rifle"
SWEP.Slot=1
SWEP.SlotPos=3
SWEP.DrawAmmo=false
...
function SWEP:DrawWorldModel()
	...
	self.NiceModel:SetModelScale(Vector(1.15,0.8,0.8))
