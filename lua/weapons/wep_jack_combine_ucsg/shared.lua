...
function SWEP:Initialize()
	...
	if(SERVER)then
		...
		self:SetNPCFireRate(0.5) --amount of time between bursts in seconds
	end
	...
	if(CLIENT)then
		...
		self.MagModel=ClientsideModel("models/Items/Flare.mdl")
		self.MagModel:SetPos(self.Owner:GetPos())
		self.MagModel:SetNoDraw(true)
		
		self.HeatSinkModel=ClientsideModel("models/props_interiors/Radiator01a.mdl")
