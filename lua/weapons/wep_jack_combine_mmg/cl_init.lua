...
language.Add("wep_jack_combine_mmg","Combine Medium Machine Gun")
killicon.Add("wep_jack_combine_mmg","vgui/killicons/wep_jack_combine_mmg",Color(255,255,255,255))

SWEP.PrintName="AI Combine Medium Machine Gun"
SWEP.Slot=1
SWEP.SlotPos=3
SWEP.DrawAmmo=false
...
function SWEP:DrawWorldModel()
	...
	pos=pos+ang:Forward()*19-ang:Up()*3+ang:Right()
	self.NiceModel:SetRenderOrigin(pos)
	ang:RotateAroundAxis(ang:Up(),180)
	ang:RotateAroundAxis(ang:Forward(),180)
	ang:RotateAroundAxis(ang:Right(),-10)
	self.NiceModel:SetAngles(ang)
	self.NiceModel:SetModelScale(Vector(1.15,1,1))
