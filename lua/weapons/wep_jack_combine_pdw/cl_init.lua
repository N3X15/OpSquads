...
language.Add("wep_jack_combine_pdw","Combine Personal Defense Weapon")
killicon.Add("wep_jack_combine_pdw","vgui/killicons/wep_jack_combine_pdw",Color(255,255,255,255))

SWEP.PrintName="AI Combine Personal Defense Weapon"
SWEP.Slot=1
SWEP.SlotPos=3
SWEP.DrawAmmo=false
...
function SWEP:DrawWorldModel()
	...
	self.MagModel:SetModelScale(Vector(0.5,1.5,0.5))
	self.BarrelModel:SetModelScale(Vector(0.95,0.6,0.6))
	self.SecondBarrelModel:SetModelScale(Vector(0.95,0.6,0.6))
