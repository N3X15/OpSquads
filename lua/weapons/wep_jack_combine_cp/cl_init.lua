...
language.Add("wep_jack_combine_cp","Combine Combat Pistol")
killicon.Add("wep_jack_combine_cp","vgui/killicons/wep_jack_combine_cp",Color(255,255,255,255))
